...
void TP06::update()
{
  ...
  #ifdef Inflammation
  	Xr1_INF=1./(1.+exp((-26.-(svolt-5))/7.)); 
  #endif
  #ifdef halvepara
  	Xr1_INF=1./(1.+exp((-26.-(svolt-2.5))/7.)); 
  #endif
...
void TP06::setDVgap_dt(double param) {dvgap_dt = param;}//param;}// mV/ms
...
double TP06::getCai() {return Cai;}
double TP06::getCaSR(){return CaSR;}
double TP06::getIKr(){return IKr;}
double TP06::getIto(){return Ito;}
double TP06::getIleak(){return Ileak;}
double TP06::getIup(){return Iup;}
